...
59sec helps companies to answer leads (or new contacts) under 1 minute (59 seconds). 
...
1. Upload the `59sec` folder to your `/wp-content/plugins/` directory.

2. Activate the "59sec" plugin in your WordPress administration interface.

3. Done! Now that post or page will point to the URL that you chose.
